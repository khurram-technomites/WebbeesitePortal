            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        debugger;
                        var actions = '';
                        actions += '<a type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Client/Project/Edit/' + data + '">' +
                            '<i class="fa fa-pen"></i>' +
                        '</a> ' +
                            '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Client/Project/Details/' + data + '\')" title="View">' +
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Client/Project/Delete/' + record,
                type: 'POST',
                data: {
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Client/Project/ToggleActiveStatus/' + record,
                type: 'Get',
