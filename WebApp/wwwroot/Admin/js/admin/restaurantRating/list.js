			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						actions += '<a type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/RestaurantRating/Details?RatingId=' + data[1] + '\')" title="View">' +
...
function Approval(element, data, status) {
	swal.fire({
		...
		if (result.isConfirmed) {
			...
			$.ajax({
				url: '/Admin/RestaurantRating/ToggleActiveStatus?RatingId=' + data,
				type: 'POST',
