            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actions += '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/SparePartsDealer/Edit/' + data + '" title="Edit">' +
                            '<i class="fa fa-pen"></i>' +
                            '</a> ';
                ...
                success: function (result) {
                    if (result.success != undefined) {
                        if (result.success) {
                            ...
                            table3.row($(element).closest('tr')).remove().draw();
                        }
                        else {
...
function callback(dialog, elem, isedit, response) {
    if (response.success) {
        ...
        if (isedit) {
            table3.row($(elem).closest('tr')).remove().draw();
        }
