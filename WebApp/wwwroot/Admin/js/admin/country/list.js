		...
		table1 = table.DataTable({
			...
			columnDefs: [{
				...
				render: function (data, type, full, meta) {
					...
					actions += /*'<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/Country/Edit/' + data + '\',true)">' +
						'<i class="fa fa-pen"></i>' +
						'</button> ' +*/
						'<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/Country/Details?CountryId=' + data + '\')" title="View">' +
...
function Activate(element, record) {
	swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				url: '/Admin/Country/ToggleActiveStatus?CountryId=' + record,
				type: 'Get',
