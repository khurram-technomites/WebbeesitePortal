			...
			columnDefs: [
				{
					...
					render: function (data, type, full, meta) {
						...
						actions += '<button type="button" class="btn btn-bg-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Restaurant/CustomerFeedback/Details/' + data + '\')" title="View">' +
...
//            $.ajax({
//                url: '/Restaurant/RestaurantUserLogManagement/Delete/' + record,
//                type: 'POST',
//                data: {
...
//            $.ajax({
//                url: '/Restaurant/RestaurantUserLogManagement/ToggleActiveStatus/' + record,
//                type: 'Get',
