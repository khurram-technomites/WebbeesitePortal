        ...
        table1 = table.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    var actions = '';
                    actions += '<a class="btn btn-secondary btn-sm mr-1" href="/Restaurant/ShopOrder/Details?id=' + full[6] + '">' +
...
function FilterStatus(f) {
    ...
    $.ajax({
        url: '/Restaurant/ShopOrder/FilterStatus',
        type: 'POST',
        data: {
            status: status
        },
...
function ChangeStatus(e) {
    ...
    $.ajax({
        url: '/Restaurant/ShopOrder/ChangeStatus',
        type: 'Post',
        data: {
            OrderId: $("#Id").val(),
...
function addRow(row) {
    ...
    table1.row.add([
        row.date,
        row.orderNo,
        row.supplierName + "|" + row.supplierPhoneNumber,
        row.total,
        row.orderDate,
        row.status,
        row.id,
