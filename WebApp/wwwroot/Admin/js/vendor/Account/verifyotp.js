$(document).ready(function () {
    ...
    $('#OTPVerificationForm').submit(function () {
       ...
       /* contact = contact.replace("+", "");*/
        ...
        //}
            ...
            console.log(otp);
            $.ajax({
                url: "Vendor/Account/VerifyOTP?UserId=" + UserId + "&OTP=" + OTP,
                type: 'Post',
                //data: {
                //    UserId: UserId,
                //    OTP: OTP
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#btnOtpVerfication').removeClass('spinner spinner-sm spinner-left').attr('disabled', false);
    ...
    $('#otpResend').click(function () {
        ...
        $.ajax({
            url: "/Vendor/Account/ResendOTP?PhoneNumber=" + contact,
            type: 'Post',
            success: function (response) {
