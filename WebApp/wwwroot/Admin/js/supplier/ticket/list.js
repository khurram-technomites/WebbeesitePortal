            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<span  onclick="OpenModelPopup(this,\'/Supplier/Ticket/StatusChange/' + full[5] + '\',true)" class="label label-lg font-weight-bold' + status[data].class + ' label-inline ">' + status[data].title + '</span>';
                    },
                },
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<a class="btn btn-bg-secondary  mr-1"  href="/Supplier/Ticket/Details/' + data + '">' +
