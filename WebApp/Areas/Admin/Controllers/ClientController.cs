...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ClientController : Controller
    {
        ...
        public ClientController(IGarageClient garageClient, IMapper mapper, ICarMakeClient carMakeclient, IGarageImageClient garageImageClient, IGarageRepairClient garageRepairClient, IGarageScheduleClient garageScheduleClient, IClientIndustriesClient industriesClient, IClientSectionsClient sectionClient, IClientTypesClient typesClient, IUserClient userClient, IModuleClient moduleClient, IClientModulePurchasesClient purchasesClient, IModulePurchaseDetailsClient modulePurchaseDetailsClient, IClientContentMediaClient contentMediaClient, IClientDomainSuggestionsClient clientDomainSuggestionsClient, IClientEmailsClient clientEmailsClient)
        {
            ...
            _contentMediaClient = contentMediaClient;
        ...
        public async Task<IActionResult> ToggleActiveStatus(long Id, bool flag, string RejectionReason)
        {
            ...
            return Json(new
            {
                ...
                data = new
                {
                    ...
                    logo = garage.Logo!=null? garage.Logo.Replace(" ", "%20"):"",
