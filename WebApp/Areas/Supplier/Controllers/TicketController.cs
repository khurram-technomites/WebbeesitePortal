...
namespace WebApp.Areas.Supplier.Controllers
{
	...
	public class TicketController : Controller
    {
        ...
        {
			long supplierId = _userSession.GetUserStore().Id;
			var info = _mapper.Map<IEnumerable<TicketViewModel>>(await _client.GetTicketsBySupplier(supplierId));
            return View(info);
		}
		...
		{
			model.SupplierId = _userSession.GetUserStore().Id;
