...
{
    [Route("api/Restaurant/Cashier/[action]")]
    [ApiController]
    public class CashierStaffAccountController : ControllerBase
    {
        ...
        private readonly ILogger<CashierStaffAccountController> _logger;
        ...
        public CashierStaffAccountController(SignInManager<AppUser> signInManager
            , UserManager<AppUser> userManager
            , IConfiguration config
            , ILogger<CashierStaffAccountController> logger
            , IMapper mapper
            ...
            , IFTPUpload fTPUpload)
        {
            ...
            _config = config;
            _logger = (ILogger<CashierStaffAccountController>)logger;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Login(LoginData model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                Response.RestaurantCashierStaff = _mapper.Map<RestaurantCashierStaffDTO>(_RestaurantCashierStaffService.GetRestaurantCashierStaffByUserAsync(User.Id).Result);
        ...
        [HttpPost]
        public async Task<IActionResult> Register(RestaurantCashierStaffDTO Model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _RestaurantCashierStaffService.AddRestaurantCashierStaffAsync(_mapper.Map<Models.RestaurantCashierStaff>(Model));
