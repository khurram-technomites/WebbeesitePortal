...
namespace WebAPI.Migrations
{
    ...
    [Migration("20230220085016_Module id for azure")]
    partial class Moduleidforazure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5af141fa-d556-4320-981b-9b5baa500cb9",
                            ConcurrencyStamp = "d607a0e3-96a1-422e-892f-4dbd09b9d9e5",
                            Name = "Admin",
            ...
            modelBuilder.Entity("WebAPI.Models.GarageMenu", b =>
                {
                    b.HasOne("WebAPI.Models.ClientModules", "ClientModule")
                        .WithMany()
                        .HasForeignKey("ModuleID");

                    b.Navigation("ClientModule");
                });
