            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        //};
                        var actions = '';
                        actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/SparePart/SparePartTestimonials/Edit?Id=' + data + '\')" title="View">' +
                            '<i class="fa fa-pen"></i>' +
                            '</button> ' +
                            '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/SparePart/SparePartTestimonials/Detail/' + data + '\')" title="View">' +
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/SparePart/SparePartTestimonials/Delete/' + record,
                type: 'POST',
                data: {
...
function GoLive(obj, f) {
    $.ajax({
        url: '/SparePart/SparePartTestimonials/ToggleActiveStatus?id=' + f,
        type: 'Get',
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/SparePart/SparePartTestimonials/ToggleActiveStatus/' + record,
                type: 'Get',
