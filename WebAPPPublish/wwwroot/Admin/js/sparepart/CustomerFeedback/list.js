        ...
        table1 = table.DataTable({
            ...
            columnDefs: [
                ...
                //    className: "dt-center",
                    ...
                    //    };
                        //var actions = '';
                        //actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Garage/GarageTeamManagement/Edit?Id=' + data + '\')" title="View">' +
                        //    '<i class="fa fa-pen"></i>' +
                        //    '</button> ' +
                        //    '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Garage/GarageTeamManagement/Detail/' + data + '\')" title="View">' +
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/SparePart/SparePartCustomerFeedback/Delete/' + record,
                type: 'POST',
                data: {
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/SparePart/SparePartCustomerFeedback/ToggleActiveStatus/' + record,
                type: 'Get',
