	...
	var initTable1 = function () {
		...
		table1 = table.DataTable({
			...
			columnDefs: [
				...
				//		return '<button type="button" class="btn btn-bg-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Supplier/CouponCategory/Index/' + data + '\',true)">' +
				...
				//},
				{
					...
					render: function (data, type, full, meta) {
						...
						if (data) {
							var actions = '<button type="button" class="btn btn-outline-success btn-sm mr-1" onclick="OpenModelPopup(this,\'/Supplier/SupplierCoupon/GetCustomers/' + data + '\',true)">' +
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Supplier/SupplierCoupon/Edit/' + data[1] + '\',true)">' +
							'<i class="fa fa-pen"></i>' +
							'</button> ' +
							'<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Supplier/SupplierCoupon/Details?id=' + data[1] + '\',true)" title="View">' +
...
function Delete(element, record) {
	...
	swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				url: '/Supplier/SupplierCoupon/Delete/' + record,
				type: 'POST',
				data: {
...
function Activate(element, record) {
	swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				url: '/Supplier/SupplierCoupon/ToggleActiveStatus/' + record,
				type: 'Get',
...
function addRow(row) {
	table1.row.add([
		row.date.toString("dd MMM yyyy, hh:mm tt"),
