        ...
        build: function () {
            ...
            if (the.options.toggleBy) {
                if (typeof the.options.toggleBy === 'string') {
                    ...
                    if (the.options.toggleBy == "kt_quick_panel_toggle") {
                        var menu_toggle = document.getElementsByClassName("kt_quick_panel_toggle");
                        for (let i = 0; i < menu_toggle.length; i++) {

                            KTUtil.addEvent(menu_toggle[i], 'click', function (e) {
                    ...
                    else if (the.options.toggleBy == "kt_quick_category_toggle") {
                        var menu_toggle = document.getElementsByClassName("kt_quick_category_toggle");
                        for (let i = 0; i < menu_toggle.length; i++) {
...
KTUtil.ready(function () {
    ...
    if (typeof KTLayoutQuickCategory !== 'undefined') {
...
var KTLayoutQuickCategory = function () {
    // Private properties
    var _element;
    var _offcanvasObject;
    var _notificationsElement;
    ...
    var _init = function () {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_category_close',
            toggleBy: 'kt_quick_category_toggle'
        });
    }
    ...
    return {
        init: function (id) {
            _element = KTUtil.getById(id);
            _notificationsElement = KTUtil.getById('kt_quick_category_general');
            _logsElement = KTUtil.getById('kt_quick_category_type');
...
if (typeof module !== 'undefined') {
    module.exports = KTLayoutQuickCategory;
}
"use strict";
