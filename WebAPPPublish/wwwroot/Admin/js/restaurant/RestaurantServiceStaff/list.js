        ...
        table1 = table.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    ...
                    actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Restaurant/RestaurantServiceStaff/Edit?Id=' + data + '\',true)">' +
                        '<i class="fa fa-pen"></i>' +
                        '</button> ' +
                        '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Restaurant/RestaurantServiceStaff/Details?Id=' + data + '\')" title="View">' +
            ...
            /*     {
                     ...
                     render: function (data, type, full, meta) {
                         ...
                         return `<div class="d-flex align-items-center">
                                 <div>
                                     <a href="javascript:;" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">${title[0]} ${title[1]}</a>
                                 </div>
                             </div>`;
                     },
                 },*/
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Restaurant/RestaurantServiceStaff/Delete/' + record,
                type: 'POST',
                data: {
                ...
                success: function (result) {
                    if (result.success != undefined) {
                        if (result.success) {
                            ...
                            toastr.success('Service staff deleted successfully ...');
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Restaurant/RestaurantServiceStaff/ToggleActiveStatus?Id=' + record,
                type: 'Get',
