		...
		table1 = table.DataTable({
			...
			columnDefs: [{
				...
				render: function (data, type, full, meta) {
					...
					var actions = '';
					actions += '<a class="btn btn-secondary btn-sm mr-1" href="/Restaurant/RestaurantOrder/Details?id=' + full[6] + '">' +
...

			{
				...
				render: function (data, type, full, meta) {
					...
					if (typeof status[data] === 'undefined') {
						return '<a  href="javascript:" class="label label-lg label-light-dark label-inline" onclick="OpenModelPopup(this,\'/Restaurant/RestaurantOrder/ChangeStatus/' + full[6] + '\',true)">' + data + '</a>';
					}
					return '<a href="javascript:" class="label label-lg ' + status[data].class + ' label-inline" onclick="OpenModelPopup(this,\'/Restaurant/RestaurantOrder/ChangeStatus/' + full[6] + '\',true)">' + data + ' </a>';
...
function ChangeBranch(f) {
	...
	$.ajax({
		url: '/Restaurant/RestaurantOrder/RestaurantBranchList',
		type: 'POST',
		data: {
			branchId: branchId,
			status: status,
...
function ChangeStatus(e) {
	...
	$.ajax({
		url: '/Restaurant/RestaurantOrder/ChangeStatus',
		type: 'Post',
		data: {
			OrderId: $("#Id").val(),
