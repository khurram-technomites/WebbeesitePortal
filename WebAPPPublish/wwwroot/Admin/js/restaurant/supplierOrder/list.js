        ...
        table1 = table.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    var actions = '';
                    actions += '<a class="btn btn-secondary btn-sm mr-1" href="/Restaurant/SupplierOrder/Details?id=' + full[5] + '">' +
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (typeof status[data] === 'undefined') {
                            return '<a  href="javascript:" class="label label-lg label-light-dark label-inline" onclick="OpenModelPopup(this,\'/Supplier/SupplierOrder/ChangeStatus/' + full[5] + '\',true)">' + data + '</a>';
                        }
                        return '<a href="javascript:" class="label label-lg ' + status[data].class + ' label-inline" onclick="OpenModelPopup(this,\'/Supplier/SupplierOrder/ChangeStatus/' + full[5] + '\',true)">' + data + ' </a>';
